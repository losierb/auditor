...
const QString create_table_records = "CREATE TABLE RECORDS (TIMESTAMP TEXT PRIMARY KEY NOT NULL,ID INTEGER NOT NULL,CHANGE INTEGER NOT NULL,AFTER INTEGER NOT NULL)";
